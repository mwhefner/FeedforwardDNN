...
# MNIST_ERRORS_1
print("MNIST_ERRORS_1")
localtime = time.asctime( time.localtime(time.time()) )
print("Time Start :", localtime)

np.random.seed(1)
x_train, y_matrix_train, y_train, x_test, y_matrix_test, y_test, ws0, bs0, ws_hat, bs_hat, train_err, test_err, errors = mlp_run_mnist_SGD_results(200, 32, [784, 450, 10], [mlp_ReLU], 0.05, mlp_constant_eta, [0.01])

localtime = time.asctime( time.localtime(time.time()) )
print("Time End :", localtime)
np.save("./results/MNIST_TRAIN_ERROR_ETA01.npy", errors[0])
np.save("./results/MNIST_TEST_ERROR_ETA01.npy", errors[1])

# MNIST_ERRORS_2
print("MNIST_ERRORS_2")
localtime = time.asctime( time.localtime(time.time()) )
print("Time Start :", localtime)

np.random.seed(1)
x_train, y_matrix_train, y_train, x_test, y_matrix_test, y_test, ws0, bs0, ws_hat, bs_hat, train_err, test_err, errors = mlp_run_mnist_SGD_results(200, 32, [784, 450, 10], [mlp_ReLU], 0.05, mlp_constant_eta, [0.02])

localtime = time.asctime( time.localtime(time.time()) )
print("Time End :", localtime)
np.save("./results/MNIST_TRAIN_ERROR_ETA02.npy", errors[0])
np.save("./results/MNIST_TEST_ERROR_ETA02.npy", errors[1])

# MNIST_ERRORS_3
print("MNIST_ERRORS_3")
localtime = time.asctime( time.localtime(time.time()) )
print("Time Start :", localtime)

np.random.seed(1)
x_train, y_matrix_train, y_train, x_test, y_matrix_test, y_test, ws0, bs0, ws_hat, bs_hat, train_err, test_err, errors = mlp_run_mnist_SGD_results(200, 32, [784, 450, 10], [mlp_ReLU], 0.05, mlp_constant_eta, [0.05])

localtime = time.asctime( time.localtime(time.time()) )
print("Time End :", localtime)
np.save("./results/MNIST_TRAIN_ERROR_ETA05.npy", errors[0])
np.save("./results/MNIST_TEST_ERROR_ETA05.npy", errors[1])

# MNIST_ERRORS_4
print("MNIST_ERRORS_4")
localtime = time.asctime( time.localtime(time.time()) )
print("Time Start :", localtime)

x_train, y_matrix_train, y_train, x_test, y_matrix_test, y_test, ws0, bs0, ws_hat, bs_hat, train_err, test_err, errors = mlp_run_mnist_SGD_results(200, 32, [784, 450, 10], [mlp_ReLU], 0.05, mlp_constant_eta, [0.1])

localtime = time.asctime( time.localtime(time.time()) )
print("Time End :", localtime)
np.save("./results/MNIST_TRAIN_ERROR_ETA1.npy", errors[0])
np.save("./results/MNIST_TEST_ERROR_ETA1.npy", errors[1])

# CIFAR_10_ERRORS_1
print("CIFAR_10_ERRORS_1")
localtime = time.asctime( time.localtime(time.time()) )
print("Time Start :", localtime)

x_train, y_matrix_train, y_train, x_test, y_matrix_test, y_test, ws0, bs0, ws_hat, bs_hat, train_err, test_err, errors = mlp_run_CIFAR_10_SGD_results(200, 32, [3072, 1024, 10], [mlp_ReLU], 0.05, mlp_constant_eta, [0.01])

localtime = time.asctime( time.localtime(time.time()) )
print("Time End :", localtime)
np.save("./results/CIFAR_10_TRAIN_ERROR_ETA01.npy", errors[0])
np.save("./results/CIFAR_10_TEST_ERROR_ETA01.npy", errors[1])

# CIFAR_10_ERRORS_2
print("CIFAR_10_ERRORS_2")
localtime = time.asctime( time.localtime(time.time()) )
print("Time Start :", localtime)

x_train, y_matrix_train, y_train, x_test, y_matrix_test, y_test, ws0, bs0, ws_hat, bs_hat, train_err, test_err, errors = mlp_run_CIFAR_10_SGD_results(200, 32, [3072, 1024, 10], [mlp_ReLU], 0.05, mlp_constant_eta, [0.02])

localtime = time.asctime( time.localtime(time.time()) )
print("Time End :", localtime)
np.save("./results/CIFAR_10_TRAIN_ERROR_ETA02.npy", errors[0])
np.save("./results/CIFAR_10_TEST_ERROR_ETA02.npy", errors[1])

# CIFAR_10_ERRORS_3
print("CIFAR_10_ERRORS_3")
localtime = time.asctime( time.localtime(time.time()) )
print("Time Start :", localtime)

x_train, y_matrix_train, y_train, x_test, y_matrix_test, y_test, ws0, bs0, ws_hat, bs_hat, train_err, test_err, errors = mlp_run_CIFAR_10_SGD_results(200, 32, [3072, 1024, 10], [mlp_ReLU], 0.05, mlp_constant_eta, [0.05])

localtime = time.asctime( time.localtime(time.time()) )
print("Time End :", localtime)
np.save("./results/CIFAR_10_TRAIN_ERROR_ETA05.npy", errors[0])
np.save("./results/CIFAR_10_TEST_ERROR_ETA05.npy", errors[1])

# CIFAR_10_ERRORS_4
print("CIFAR_10_ERRORS_4")
localtime = time.asctime( time.localtime(time.time()) )
print("Time Start :", localtime)

x_train, y_matrix_train, y_train, x_test, y_matrix_test, y_test, ws0, bs0, ws_hat, bs_hat, train_err, test_err, errors = mlp_run_CIFAR_10_SGD_results(200, 32, [3072, 1024, 10], [mlp_ReLU], 0.05, mlp_constant_eta, [0.1])

localtime = time.asctime( time.localtime(time.time()) )
print("Time End :", localtime)
np.save("./results/CIFAR_10_TRAIN_ERROR_ETA1.npy", errors[0])
np.save("./results/CIFAR_10_TEST_ERROR_ETA1.npy", errors[1])

# CIFAR_100_ERRORS_1
print("CIFAR_100_ERRORS_1")
localtime = time.asctime( time.localtime(time.time()) )
print("Time Start :", localtime)

x_train, y_matrix_train, y_train, x_test, y_matrix_test, y_test, ws0, bs0, ws_hat, bs_hat, train_err, test_err, errors = mlp_run_CIFAR_100_SGD_results(200, 32, [3072, 1024, 100], [mlp_ReLU], 0.05, mlp_constant_eta, [0.01])

localtime = time.asctime( time.localtime(time.time()) )
print("Time End :", localtime)
np.save("./results/CIFAR_100_TRAIN_ERROR_ETA01.npy", errors[0])
np.save("./results/CIFAR_100_TEST_ERROR_ETA01.npy", errors[1])

# CIFAR_100_ERRORS_2
print("CIFAR_100_ERRORS_2")
localtime = time.asctime( time.localtime(time.time()) )
print("Time Start :", localtime)

x_train, y_matrix_train, y_train, x_test, y_matrix_test, y_test, ws0, bs0, ws_hat, bs_hat, train_err, test_err, errors = mlp_run_CIFAR_100_SGD_results(200, 32, [3072, 1024, 100], [mlp_ReLU], 0.05, mlp_constant_eta, [0.02])

localtime = time.asctime( time.localtime(time.time()) )
print("Time End :", localtime)
np.save("./results/CIFAR_100_TRAIN_ERROR_ETA02.npy", errors[0])
np.save("./results/CIFAR_100_TEST_ERROR_ETA02.npy", errors[1])

# CIFAR_100_ERRORS_3
print("CIFAR_100_ERRORS_3")
localtime = time.asctime( time.localtime(time.time()) )
print("Time Start :", localtime)

x_train, y_matrix_train, y_train, x_test, y_matrix_test, y_test, ws0, bs0, ws_hat, bs_hat, train_err, test_err, errors = mlp_run_CIFAR_100_SGD_results(200, 32, [3072, 1024, 100], [mlp_ReLU], 0.05, mlp_constant_eta, [0.05])

localtime = time.asctime( time.localtime(time.time()) )
print("Time End :", localtime)
np.save("./results/CIFAR_100_TRAIN_ERROR_ETA05.npy", errors[0])
np.save("./results/CIFAR_100_TEST_ERROR_ETA05.npy", errors[1])


# python CIFAR_100_ERRORS_4
print("CIFAR_100_ERRORS_4")
localtime = time.asctime( time.localtime(time.time()) )
print("Time Start :", localtime)

x_train, y_matrix_train, y_train, x_test, y_matrix_test, y_test, ws0, bs0, ws_hat, bs_hat, train_err, test_err, errors = mlp_run_CIFAR_100_SGD_results(200, 32, [3072, 1024, 100], [mlp_ReLU], 0.05, mlp_constant_eta, [0.1])

localtime = time.asctime( time.localtime(time.time()) )
print("Time End :", localtime)
np.save("./results/CIFAR_100_TRAIN_ERROR_ETA1.npy", errors[0])
np.save("./results/CIFAR_100_TEST_ERROR_ETA1.npy", errors[1])
